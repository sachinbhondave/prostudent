...
<div id="page">
  <div id="header">
    ...
    <ul>
      ...
      <li class="current"><a href="blog.jsp">Student billing</a></li>
  ...
  <div id="content">
    <div>
  <form action="Cbilling" method=Post name="Studentbill">
      
<table cellpadding="2" width="70%" bgcolor="99FFFF" align="center" cellspacing="2">
<tr>
<td colspan=2>
<center><font size=4><b>Student fees Form</b></font></center>
</td>
</tr>
...
<tr>
<td>Remain Fees paid</td>
<td><input type="text" name="billFees"
id="billFees" size="30"></td>
</tr>
  <tr>
 <td> </td>
